...
@interface refillbyscanObject : KrollCoverageObject {
#else
@interface refillbyscanObject : KrollObject {
#endif
@private
...
extern NSString * refillbyscan$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	refillbyscanObject *_refillbyscan;
    KrollObject* console;
	BOOL shutdown;
