...
//@interface refillbyscanObject : NSObject
//@end

@interface refillbyscanObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[refillbyscanObject class]])
		{
			for (NSString *key in [[(refillbyscanObject*)o modules] allKeys])
			{
