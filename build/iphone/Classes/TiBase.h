...
// in simulator we redefine to format for refillbyscan Developer console
...
{\
	NSString * exceptionName = [@"org.refillbyscan." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.refillbyscan";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIrefillbyscanNativeItemNone = -1, 
	UIrefillbyscanNativeItemSpinner = -2,
	UIrefillbyscanNativeItemProgressBar = -3,
	
	UIrefillbyscanNativeItemSlider = -4,
	UIrefillbyscanNativeItemSwitch = -5,
	UIrefillbyscanNativeItemMultiButton = -6,
	UIrefillbyscanNativeItemSegmented = -7,
	
	UIrefillbyscanNativeItemTextView = -8,
	UIrefillbyscanNativeItemTextField = -9,
	UIrefillbyscanNativeItemSearchBar = -10,
	
	UIrefillbyscanNativeItemPicker = -11,
	UIrefillbyscanNativeItemDatePicker = -12,
	
	UIrefillbyscanNativeItemInfoLight = -13,
	UIrefillbyscanNativeItemInfoDark = -14,
	
	UIrefillbyscanNativeItemDisclosure = -15,
	
	UIrefillbyscanNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all refillbyscan instances of
