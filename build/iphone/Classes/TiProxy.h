...
//Rare exceptions to indicate a bug in the _refillbyscan code (Eg, function that a subclass should have implemented)
...
/**
 The base class for refillbyscan proxies.
 */
