...
/**
 Base class for all refillbyscan views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the refillbyscan view hierarchy (such as wrapped iOS UIViews) was touched.
